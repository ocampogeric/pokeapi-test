 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="PokemonAbility" type="{http://soap.ocampogeric.com/pokemon}pokemonAbility" maxOccurs="unbounded" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class GetPokemonAbilitiesResponse {
    ...
    @XmlElement(name = "PokemonAbility", nillable = true)
