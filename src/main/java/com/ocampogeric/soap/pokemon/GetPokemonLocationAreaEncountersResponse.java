 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="LocationArea" type="{http://soap.ocampogeric.com/pokemon}locationArea" maxOccurs="unbounded" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class GetPokemonLocationAreaEncountersResponse {
    ...
    protected List<LocationArea> locationArea;
    ...
    public List<LocationArea> getLocationArea() {
        if (locationArea == null) {
            locationArea = new ArrayList<LocationArea>();
        }
